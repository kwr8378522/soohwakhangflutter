...
class SoilMoistureGraphCard extends StatelessWidget {
  SoilMoistureGraphCard({Key? key, required this.viewModel}) : super(key: key);
        ...
        child: SfCartesianChart(
            ...
            series: <ChartSeries<SooHwakData, DateTime>>[
              LineSeries<SooHwakData, DateTime>(
                ...
                yValueMapper: (SooHwakData soohwak, _) => soohwak.soilMoisture,
                name: "토양 수분",
              )
            ]));
  }
